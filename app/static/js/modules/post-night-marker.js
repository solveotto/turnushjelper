    ...
    processTable(table) {
        ...
        for (let i = 0; i < allDayCells.length - 1; i++) {
            ...
            if (this.isNightShift(cell) && this.isDayOff(nextCell)) {
                if (nextCell.classList.contains("post-night-recovery"))
                ...
                if (timeEl) {
                    ...
                    timeEl.innerHTML +=
                        '<div><img src="/static/img/bed.png" alt="recovery" style="width:18px;height:18px;opacity:0.6;margin-left:-50px;"></div>';
                }
            }
        }
    }
