...
def generate_statistics_for_year(year_id):
    ...
    import os
    turnus_path = os.path.join(AppConfig.turnusfiler_dir, year_id.lower(), f'turnus_schedule_{year_id}.json')
    df_path = os.path.join(AppConfig.turnusfiler_dir, year_id.lower(), f'turnus_stats_{year_id}.json')
...
if __name__ == '__main__':
    ...
    if args.all:
        ...
        import os
        turnusfiler_dir = AppConfig.turnusfiler_dir
