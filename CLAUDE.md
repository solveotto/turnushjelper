...
- **Strekliste PNGs**: ruler/crop geometry auto-calibrates from the PDF's printed hour header (`app/utils/pdf/strekliste_generator.py`, covered by `tests/test_strekliste_geometry.py`). Regenerate the PNGs after any streker-PDF swap.
